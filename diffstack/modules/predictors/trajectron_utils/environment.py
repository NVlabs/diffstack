...
class EnvironmentMetadata(Environment):
    ...
    def __init__(self, env):
        super(EnvironmentMetadata, self).__init__(node_type_list=env.node_type_list,
                                                  standardization=env.standardization,
                                                  scenes=None,
                                                  attention_radius=env.attention_radius,
                                                  robot_type=env.robot_type,
                                                  dt=env.dt)
        self.standardize_param_memo = env.standardize_param_memo
        self._scenes_resample_prop = env._scenes_resample_prop
