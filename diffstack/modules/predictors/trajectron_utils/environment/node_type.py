class NodeType(object):
    ...
    def __eq__(self, other):
        if type(other) == str and self.name == other:
            ...
            # Only check if class names match, so relative and absolute imports will be treated equal.
            return (isinstance(other, self.__class__) or (other.__class__.__name__ == self.__class__.__name__))  and self.name == other.name
