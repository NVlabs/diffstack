...
import numpy as np
from diffstack.modules.predictors.trajectron_utils.model.model_utils import to_one_hot
...
class GMM2D(td.Distribution):
    ...
    def set_device(self, device):
        ...
        if self.pis_cat_dist is not None:
    ...
    def rsample(self, sample_shape=torch.Size()):
        ...
        mvn_samples = (self.mus +
                       torch.squeeze(
                           ...
                           dim=-1))
        if self.pis_cat_dist is None:
            raise NotImplementedError  # not tested
            component_cat_samples = torch.zeros(sample_shape)
        else:
    ...
    def log_prob(self, value):
        ...
        dx = value - self.mus[..., :value.shape[-1]]                    # [..., N, 2]
